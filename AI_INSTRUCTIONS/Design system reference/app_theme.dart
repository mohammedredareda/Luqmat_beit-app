...
//
//  هذا الملف هو الترجمة الحرفية لوثيقة sumac_design_system.html
//  أي تعديل على قيمة هنا يجب أن يُعدَّل في الوثيقة، والعكس صحيح.
//
//  الخطوط: أضف حزمة google_fonts في pubspec.yaml:
//      google_fonts: ^6.2.1
//  أو حمّل Alexandria و Tajawal كـ assets وسجّلهما بنفس الأسماء.
//
//  ملاحظة توافق: الأسماء CardThemeData / DialogThemeData / TabBarThemeData
//  تتطلب Flutter 3.29 أو أحدث. للإصدارات الأقدم استبدلها بـ
//  CardTheme / DialogTheme / TabBarTheme (نفس الخصائص تماماً).
// ============================================================================
