    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          LoadingSkeleton(width: 48, height: 28, borderRadius: AppRadius.pill),
        ],
      ),
    );
  }
...
class _MealRowSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        children: [
          LoadingSkeleton(width: 96, height: 96, borderRadius: AppRadius.image),
          ...
          LoadingSkeleton(width: 32, height: 32, borderRadius: AppRadius.pill),
        ],
      ),
    );
  }
