...
class _LoadedBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (background, foreground) = order.status.colorsOf(statusColors);
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          OrderStatusBadge(label: statusLabel, background: background, foreground: foreground),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          row(l10n.subtotalLabel, order.subtotal),
          if (order.discount > 0)
            row(l10n.discountLabel, -order.discount, isDiscount: true),
          const Divider(height: AppSpace.l),
          row(l10n.totalLabel, order.total, isTotal: true),
        ],
      ),
    );
  }
