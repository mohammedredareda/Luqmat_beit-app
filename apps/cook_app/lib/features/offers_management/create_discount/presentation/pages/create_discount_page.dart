...
import '../../../shared/presentation/widgets/restriction_mode_segmented_control.dart';
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (state.selectedMeal != null && percentage != null) ...[
                ...
                if (!state.selectedMeal!.hasVariations)
                  DiscountPriceAfterRow(
                    ...
                    oldPrice: state.selectedMeal!.displayPrice,
              ...
              const SizedBox(height: AppSpace.l),
              RestrictionModeSegmentedControl(
                mode: state.mode,
                durationLabel: l10n.createRestrictionByDurationLabel,
                usageLabel: l10n.createRestrictionByUsageLabel,
                onChanged: (mode) => bloc.add(CreateDiscountEvent.restrictionModeChanged(mode)),
              ),
              const SizedBox(height: AppSpace.l),
              if (state.mode == DiscountRestrictionMode.duration)
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: '7',
                    errorText: _fieldError(l10n, fieldErrors, 'restriction'),
                  ),
                )
              else
                TextFormField(
                  ...
                  textAlign: TextAlign.left,
                  decoration: InputDecoration(
                    labelText: l10n.usageLimitFieldLabel,
