...
/// the shared `otp_verification` mockup's 4-box code entry. Test code is
/// always `1234` against the mock datasource (see
/// `AuthMockDataSource.testOtpCode`).
    ...
    return BlocListener<OtpCubit, OtpState>(
      ...
      listener: (context, state) async {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('تم تأكيد رقم هاتفك بنجاح.')),
        );
