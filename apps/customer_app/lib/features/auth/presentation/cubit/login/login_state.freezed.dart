...
class _$LoginSubmittingImpl implements LoginSubmitting {
  const _$LoginSubmittingImpl();
...
abstract class LoginSubmitting implements LoginState {
...
class _$LoginFailureImpl implements LoginFailure {
  const _$LoginFailureImpl(this.exception);
...
abstract class LoginFailure implements LoginState {
  const factory LoginFailure(final AppException exception) = _$LoginFailureImpl;
