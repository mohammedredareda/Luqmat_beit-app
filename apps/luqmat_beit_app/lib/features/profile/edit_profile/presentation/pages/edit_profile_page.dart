...
// Reused directly from the cook module — fully decoupled from any
// cook-specific type (just `avatarPath`/`onImagePicked`/`errorText`), per
// the user's request to import and reuse it rather than duplicating it.
import 'package:luqmat_beit_app/features/cook_profile/edit_profile/presentation/widgets/profile_avatar_picker.dart';
...
/// Customer Edit Profile. No bottom nav — a task-focused sub-screen reached
/// from the Profile tab, mirroring the cook module's `EditProfilePage`
/// minus the cook-only bio/availability fields.
    ...
    return ListView(
      ...
      children: [
        ...
        TextFormField(
          ...
          onChanged: (value) => bloc.add(EditProfileEvent.nameChanged(value)),
...
/// Mirrors the cook module's `_LocationDetector` — read-only coords field +
/// "Detect" button — never overwrites the independently-editable address
/// field above it.
