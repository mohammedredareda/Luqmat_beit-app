...
mixin _$ProfileState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(CookProfileDetails profile) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(CookProfileDetails profile)? loaded,
...
abstract class _$$ProfileLoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({CookProfileDetails profile});
}
...
abstract class ProfileLoaded implements ProfileState {
  const factory ProfileLoaded(final CookProfileDetails profile) =
      _$ProfileLoadedImpl;

  CookProfileDetails get profile;
...
class _$ProfileErrorImpl implements ProfileError {
  const _$ProfileErrorImpl(this.exception);
...
abstract class ProfileError implements ProfileState {
  const factory ProfileError(final AppException exception) = _$ProfileErrorImpl;
