import 'package:luqmat_beit_app/features/offers_management/create_offer/data/repositories/create_offer_repository_impl.dart';
import 'package:luqmat_beit_app/features/offers_management/shared/data/datasources/fake_offers_remote_data_source.dart';
import 'package:luqmat_beit_app/features/offers_management/shared/domain/offer_form_submission.dart';
import 'package:luqmat_beit_app/features/offers_management/view_offers/data/repositories/view_offers_repository_impl.dart';
...
void main() {
  ...
  test('createOffer returns Result.success with the new offer', () async {
    ...
    expect(offer.meals, hasLength(1));
  });
