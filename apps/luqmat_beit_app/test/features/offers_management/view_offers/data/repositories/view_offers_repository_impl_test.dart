    ...
    for (final item in page.items) {
      switch (item) {
        case OfferFeedOfferItem(:final offer):
          ...
          expect(offer.isActive && remainingDays > 0, isTrue);
        case OfferFeedDiscountItem(:final discount):
          final expired = discount.expiryTime.difference(DateTime.now()).inDays <= 0 ||
              (discount.usageNumberLimit != null &&
                  discount.usageNumberLimit! - discount.usageCount <= 0);
